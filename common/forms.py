...
class BillingAddressForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["address_line"].widget.attrs.update({"placeholder": ""})
        self.fields["street"].widget.attrs.update({"placeholder": "Street"})
        self.fields["city"].widget.attrs.update({"placeholder": "Class"})
        self.fields["state"].widget.attrs.update({"placeholder": "Section"})
        self.fields["postcode"].widget.attrs.update({"placeholder": "UMID"})
